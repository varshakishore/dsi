...
learning_rate=0.001
train_epochs=20
output_dir="/home/vk352/dsi/NQ320k_baselines/dpr_0.001_doc_only_noq/"
logging_step=200
...
wandb_name="dpr_0.001_doc_only_noq"
...
--freeze_base_model --initialize_model $model_path --wandb_name $wandb_name --doc_index_only"
